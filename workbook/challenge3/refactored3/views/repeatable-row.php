<div class="postbox plugin-row plugin-repeatable-grouping<?php esc_attr_e( $closed_class ); ?>" data-iterator="<?php esc_attr_e( $field_group->index ); ?>">
	<?php if ( $field_group->args( 'repeatable' ) ) : ?>
		<button type="button"<?php esc_attr_e( $remove_disabled ); ?> data-selector="<?php esc_attr_e( $field_group->id() ); ?>_repeat" class="dashicons-before dashicons-no-alt plugin-remove-group-row"></button>
	<?php endif; ?>
		...
		if ( $field_group->args( 'repeatable' ) ) : ?>
			<div class="plugin-row plugin-remove-field-row">
				<div class="plugin-remove-row">
					<button type="button"<?php esc_attr_e( $remove_disabled ); ?> data-selector="<?php esc_attr_e( $field_group->id() ); ?>_repeat" class="button plugin-remove-group-row alignright"><?php esc_html_e( $field_group->options( 'remove_button' ) ); ?></button>
				</div>
			</div>
		<?php endif; ?>
	</div>
